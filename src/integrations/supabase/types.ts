...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      emergency_contacts: {
        Row: {
          contact_type: Database["public"]["Enums"]["emergency_type"]
          created_at: string | null
          email: string | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "emergency_contacts_temple_id_fkey"
            columns: ["temple_id"]
            isOneToOne: false
            referencedRelation: "temples"
            referencedColumns: ["id"]
      ...
      queue_status: {
        Row: {
          ...
          id: string
          last_updated: string | null
          status: Database["public"]["Enums"]["queue_status_type"] | null
          temple_id: string
      ...
      staff: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_temple_id_fkey"
            columns: ["temple_id"]
            isOneToOne: false
            referencedRelation: "temples"
            referencedColumns: ["id"]
      ...
      temples: {
        Row: {
          ...
          closing_time: string
          created_at: string | null
          current_crowd_level: Database["public"]["Enums"]["crowd_level"] | null
          description: string | null
          email: string | null
        ...
        Insert: {
          ...
          created_at?: string | null
          current_crowd_level?:
            | Database["public"]["Enums"]["crowd_level"]
            | null
          description?: string | null
          email?: string | null
          facilities?: string[] | null
    ...
    Enums: {
      accessibility_need:
        ...
        | "elderly"
        | "mobility_assistance"
      app_role: "devotee" | "admin" | "security" | "temple_staff"
      ...
      queue_status_type: "active" | "paused" | "completed"
      staff_role: "admin" | "security" | "medical" | "volunteer" | "priest"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
